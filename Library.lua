...
function Library:AddToolTip(InfoStr, HoverInstance)
    ...
    Library:Create('UIStroke', { Color = Library.OutlineColor, Thickness = 1, Transparency = 0.5, Parent = Tooltip });
    ...
    HoverInstance.MouseEnter:Connect(function()
        ...
        IsHovering = true;
        Tooltip.Position = UDim2.fromOffset(Mouse.X + 18, Mouse.Y + 15);
...
do
    ...
    function Funcs:AddColorPicker(Idx, Info)
        ...
        Library:Create('UICorner', { CornerRadius = UDim.new(0, 3), Parent = CheckerFrame });
        ...
        Library:Create('UIScale', { Scale = 0.95, Parent = PickerFrameOuter });
        ...
        Library:Create('UICorner', { CornerRadius = UDim.new(0, 7), Parent = PickerFrameInner });
        Library:Create('UIStroke', { Color = Library.OutlineColor, Thickness = 1, Transparency = 0.5, Parent = PickerFrameInner });
        ...
        Library:Create('UICorner', { CornerRadius = UDim.new(0, 7), Parent = Highlight });
        ...
        Library:Create('UICorner', { CornerRadius = UDim.new(0, 5), Parent = SatVibMapInner });
        ...
        Library:Create('UICorner', { CornerRadius = UDim.new(0, 5), Parent = SatVibMap });
        ...
        Library:Create('UICorner', { CornerRadius = UDim.new(0, 6), Parent = HueSelectorOuter });
        ...
        Library:Create('UICorner', { CornerRadius = UDim.new(0, 5), Parent = HueSelectorInner });
        ...
        Library:Create('UICorner', { CornerRadius = UDim.new(0, 5), Parent = HueBoxOuter });
        ...
        Library:Create('UICorner', { CornerRadius = UDim.new(0, 4), Parent = HueBoxInner });
        ...
        if Info.Transparency then
            ...
            Library:Create('UICorner', { CornerRadius = UDim.new(0, 5), Parent = TransparencyBoxOuter });
        ...
        do
            ...
            Library:Create('UIStroke', { Color = Library.OutlineColor, Thickness = 1, Transparency = 0.5, Parent = ContextMenu.Container });
            ...
            Library:Create('UICorner', { CornerRadius = UDim.new(0, 5), Parent = ContextMenu.Inner });
        ...
        function ColorPicker:Show()
            ...
            TweenService:Create(PickerFrameOuter.UIScale, TweenInfo.new(0.15, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), { Scale = 1 }):Play();
        end;

        function ColorPicker:Hide()
            TweenService:Create(PickerFrameOuter.UIScale, TweenInfo.new(0.1, Enum.EasingStyle.Quad, Enum.EasingDirection.In), { Scale = 0.95 }):Play();
    ...
    function Funcs:AddKeyPicker(Idx, Info)
        ...
        Library:Create('UIScale', { Scale = 0.95, Parent = ModeSelectOuter });
        ...
        Library:Create('UIStroke', { Color = Library.OutlineColor, Thickness = 1, Transparency = 0.5, Parent = ModeSelectInner });
        ...
        for _, Mode in next, Modes do
            ...
            function ModeButton:Select()
                ...
                TweenService:Create(ModeSelectOuter.UIScale, TweenInfo.new(0.1, Enum.EasingStyle.Quad, Enum.EasingDirection.In), { Scale = 0.95 }):Play();
                task.delay(0.1, function() ModeSelectOuter.Visible = false; end);
            end;
        ...
        PickOuter.InputBegan:Connect(function(Input)
            ...
            elseif Input.UserInputType == Enum.UserInputType.MouseButton2 and not Library:MouseIsOverOpenedFrame() then
                ...
                TweenService:Create(ModeSelectOuter.UIScale, TweenInfo.new(0.15, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), { Scale = 1 }):Play();
            end;
        end);
...
do
    ...
    function Funcs:AddDivider()
        ...
        Library:Create('UICorner', { CornerRadius = UDim.new(0, 3), Parent = DividerOuter });
        ...
        Library:Create('UICorner', { CornerRadius = UDim.new(0, 2), Parent = DividerInner });
    ...
    function Funcs:AddSlider(Idx, Info)
        ...
        Library:Create('UICorner', { CornerRadius = UDim.new(0, 7), Parent = SliderOuter });
        ...
        Library:Create('UICorner', { CornerRadius = UDim.new(0, 6), Parent = SliderInner });
        ...
        Library:Create('UICorner', { CornerRadius = UDim.new(0, 6), Parent = Fill });
    ...
    function Funcs:AddDropdown(Idx, Info)
        ...
        Library:Create('UIScale', { Scale = 0.95, Parent = ListOuter });
        ...
        Library:Create('UICorner', { CornerRadius = UDim.new(0, 7), Parent = ListInner });
        Library:Create('UIStroke', { Color = Library.OutlineColor, Thickness = 1, Transparency = 0.5, Parent = ListInner });
        ...
        function Dropdown:OpenDropdown()
            ...
            TweenService:Create(ListOuter.UIScale, TweenInfo.new(0.15, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), { Scale = 1 }):Play();
        end;

        function Dropdown:CloseDropdown()
            TweenService:Create(ListOuter.UIScale, TweenInfo.new(0.1, Enum.EasingStyle.Quad, Enum.EasingDirection.In), { Scale = 0.95 }):Play();
            task.delay(0.1, function()
...
do
    ...
    Library:Create('UIStroke', { Color = Library.OutlineColor, Thickness = 1, Transparency = 0.5, Parent = WatermarkOuter });
    ...
    Library:Create('UICorner', { CornerRadius = UDim.new(0, 7), Parent = WatermarkInner });
    ...
    Library:Create('UICorner', { CornerRadius = UDim.new(0, 6), Parent = InnerFrame });
    ...
    Library:Create('UIStroke', { Color = Library.OutlineColor, Thickness = 1, Transparency = 0.5, Parent = KeybindOuter });
    ...
    Library:Create('UICorner', { CornerRadius = UDim.new(0, 7), Parent = KeybindInner });
    ...
    Library:Create('UICorner', { CornerRadius = UDim.new(0, 7), Parent = ColorFrame });
...
function Library:Notify(Text, Time)
    ...
    Library:Create('UIStroke', { Color = Library.OutlineColor, Thickness = 1, Transparency = 0.5, Parent = NotifyOuter });
    ...
    Library:Create('UICorner', { CornerRadius = UDim.new(0, 7), Parent = NotifyInner });
    ...
    Library:Create('UICorner', { CornerRadius = UDim.new(0, 8), Parent = LeftColor });
...
function Library:CreateWindow(...)
    ...
    Library:Create('UIScale', { Scale = 0.95, Parent = Outer });

    -- Backdrop blur / glow effect
    ...
    Library:Create('UICorner', { CornerRadius = UDim.new(0, 16), Parent = Backdrop });
    ...
    Library:Create('UICorner', { CornerRadius = UDim.new(0, 14), Parent = Glow });
    ...
    Library:Create('UICorner', { CornerRadius = UDim.new(0, 10), Parent = MainSectionOuter });
    ...
    Library:Create('UICorner', { CornerRadius = UDim.new(0, 9), Parent = MainSectionInner });
    ...
    Library:Create('UICorner', { CornerRadius = UDim.new(0, 9), Parent = TabContainer });
    Library:Create('UIStroke', { Color = Library.OutlineColor, Thickness = 1, Transparency = 0.3, Parent = TabContainer });
    ...
    function Window:AddTab(Name)
        ...
        function Tab:AddGroupbox(Info)
            ...
            Library:Create('UIStroke', { Color = Library.OutlineColor, Thickness = 1, Transparency = 0.2, Parent = BoxOuter });
            ...
            Library:Create('UICorner', { CornerRadius = UDim.new(0, 9), Parent = BoxInner });
            ...
            Library:Create('UICorner', { CornerRadius = UDim.new(0, 9), Parent = Highlight });
            Library:AddToRegistry(Highlight, { BackgroundColor3 = 'AccentColor'; });
    ...
    function Library:Toggle()
        ...
        if Toggled then
            ...
            Outer.Visible = true;
            TweenService:Create(Outer.UIScale, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), { Scale = 1 }):Play();

            Library:InitParticles(ParticleLayer);
            ...
            TweenService:Create(Outer.UIScale, TweenInfo.new(0.15, Enum.EasingStyle.Quad, Enum.EasingDirection.In), { Scale = 0.95 }):Play();
        end;
        ...
        if not Toggled then
            ...
            if Library.ParticleConnection then
                Library.ParticleConnection:Disconnect();
                Library.ParticleConnection = nil;
            end;
            if Library.Particles then
                for _, p in next, Library.Particles do p:Remove(); end;
                Library.Particles = nil;
            end;
            if Library.ParticleLines then
                for _, l in next, Library.ParticleLines do l:Remove(); end;
                Library.ParticleLines = nil;
            end;
        end;
